      ...
      contents: [
        {
          ...
          text: [
            ...
            "",
            "**AI Chatbot & Ingest** (monthly, per billing period):",
            "- `chatbot_tokens_monthly` — total AI tokens (ingest + replies)",
            "- `chatbot_ingest_tokens_monthly` — knowledge indexing / embedding",
            "- `chatbot_reply_tokens_monthly` — RAG queries and generated replies",
            "- `chatbot_knowledge_sources`, `chatbot_chunks` — per-bot caps",
            "",
            "**Login with WhatsApp**:",
            "- `whatsapp_login_apps` — Flutter/Web login apps",
            "- `whatsapp_login_sessions_monthly` — login sessions started per month",
            "",
            "`0` on any limit = unlimited. See `mess-api/docs/PLAN_LIMITS.md` for recommended tier values.",
            "",
            "Before creating automations, templates, chatbots, or auth apps, check usage to avoid plan limit errors from the API.",
            "",
